package com.ensharp.seoul.seoultheplace.UIElement.FloatingButton;
...
//  }
  ...
  public void init(Context context, AttributeSet attributeSet) {
    ...
    mAddButtonPlusColor = attr.getColor(R.styleable.FloatingActionsMenu_fab_addButtonPlusIconColor, getColor(R.color.plus_color));
    mAddButtonColorNormal = attr.getColor(R.styleable.FloatingActionsMenu_fab_addButtonColorNormal, getColor(R.color.plus_color_normal));
    mAddButtonColorPressed = attr.getColor(R.styleable.FloatingActionsMenu_fab_addButtonColorPressed, getColor(R.color.plus_pressed));
  ...
  private void createLabels() {
    ...
    for (int i = 0; i < mButtonsCount; i++) {
      ...
      label.setTextSize(TypedValue.COMPLEX_UNIT_PX, getResources().getDimension(R.dimen.plus_button_text_size));
